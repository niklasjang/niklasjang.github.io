...
- 저축은행
  - [새마을금고](https://www.kfcc.co.kr/recruit/rec0095.do)
  - [신협](http://www.cu.co.kr/CPSN080000.do?pgm_code=MP020190&pageNo=1&pageGNo=0)
...
1. 농협은행
  - 직무
    1. IT개발(상호금융, 경제/유통시스템)
    1. 정보보안(보안 침해사고 분석 및 대응)
    1. ICT신기술(빅데이터, 인공지능)
  - 자격증 가산 : 
    1. 전자계산기기사, 기술사, 조직응용기사, 조직응용기술사
    1. 컴퓨터시스템응용기술사
    1. 정보처리기사
    1. 정보관리기술사
    1. 정보통신기사, 기술사
1. 신한은행
  - 직무
    1. 뱅킹서비스, 정보성 업무, 보고 시스템
    1. 모바일, 웹 서비스
    1. 신기술 블체, 기계학습 , 빅데이터, open API
    1. 정보보호
1. 기업은행
  - 직무 :
    1. IT
...
1. 우리은행
  - 직무 :
    1. (IT)IT전략 수립/추진, 서비스 투자 기획
    1. IT프로젝트 지원, 통제, 장애관리
    1. 정보보호, 상품/서비스 전산개발 
    1. 비대면채널,플랫폼,핀테크, 전략 및 서비스
    1. (디지털) AI 기반 사업 기획. 모델링
    1. 블록체인 활용 금융 서비스 개발
    1. 빅데이터 활용 전략 수립 및 통계 활용, 비정형데이터 분석 지원
  - 자격증 가산 :
    1. 정보관리기술사
    1. 정보보안기사
    1. ADP
...
1. 새마을금고
  - 직무 :
    1. 금융서비스(여수신/공제(보험)/전자금융/체크카드 등) 프로그램 개발 및 유지보수
    1. 전산시스템 하드웨어 소프트웨어 운영 및 유지보수
    1. IT 보안 점검, 보안 침해사고 방지 및 대응 시스템 구축
  - 자격증 가산 :
    1. 정보처리기사(필수)
    1. SQLP
    1. DAP
...
1. 신협
  - 직무 : 
    1. IT 개발(Oracle DB, Unix server, android ,iOS)
    1. IT 운영 관리(DB, ORACLE)

## 투자증권 직무 및 우대사항 정리

1. NH투자증권
  - 직무 :
    1. IT 개발 및 운영 업무(시스템 및 네트워크)
    1. Digital : 빅데이터, 머신러닝, 모바일
  - 가산 :  
    1. 외국어능력 우수자
    1. 금융 및 IT 관련 자격증 소지자
1. 신한금융투자
  - 직무 :
    1. IT HTS/MTS/ Web 등 고객용 채널 개발/운영/지원
    1. 금융투자 비즈니스 시스템 개발 운영 지원
    1. Digital 디지털 전략, 사업 기획
    1. 제휴업체 신규 발굴 및 신사업 디지털 투자
    1. HTS/ MTS 등 플랫폼 전략 및 기획/운영
    1. DT(Digital Transformation) 추진
    1. 정보보호(정보 보안 인프라 구축 및 정보보안 활동)
  - 가산 :  
    1. 핀테크에 대한 이해 및 경험
    1. IT관련 전공, 관련 자격 보유
1. SK증권
  - 직무 : 
    1. (Quity운용본부) 주식 선물 옵션 운용, 롱숏 바스켓 매매, 상품전략개발 및 운용
    1. 리스크관리 시스템 구축/운영, 자산운용정책 및 한도배분
    1. (모바일본부 인턴) 증권 제휴 서비스 개발 지원
    1. 신규 핀테크 기술 관련 업무 지원
      1. HTTP/REST/DNS/oAuth 프로토콜 기술에 대한 이해
      1. Javascript에 대한 전문적 개발 역량과 HTML/CSS에 대한 이해
      1. (우대) React, Angular, Vue 개발 경험
      1. MySQL, MongoDB 사용 경험
      1. HTML, CSS.js 등고 템플릿(bootstrap)등을 이용한 화면개발 경험
1. KB증권
  - 직무 :
    1. (IT)클라우드컴퓨팅, AI, 머신러닝, OPEN API 등 개발 운영
    1. 정보보호 관련 전산개발 지원
    1. 업무프로세스 및 인프라 개발 운영
    1. 정보보호, 데이터분석, 핀테크, 디지털 마케팅
    1. 투자금융업무 응용프로그램 개발, 시스템 프로그래밍, IT 인프라 운영
    1. HTS, MTS 웹/앱 등 클라이언트 개발 및 운영
    1. 빅데이터, 데이터 분석, AI 핀테크 및 디지털마케팅 관련 업무
1. 미래에셋대우
  - 직무 :
    1. 핀테크, AI, 빅데이터 플랫폼 활용 비지니스
    1. IT 전략 수립,기획, IT인프라, 시스템.업무 및 컨텐츠 개발 운용 업무
  - 가산 :
    1. 디지털금융 및 IT 관련 대회 공모전(빅데이터, AI, 핀테크, 디지털 금융 관련 앱개발 등) 수상자
    1. 디지털금융 관련 근무 경력자 및 IT 관련 전문지식 보유자
1. 한국투자증권
  - 직무 : 
    1. 홈페이지 증권 업무 개발
    1. 국내팟애상품 업무 개발
    1. RPA 업무 개발 (UiPath) 사용 자동화 개발 경험
    1. 금융권 출납업무 개발
    1. 수익증권 업무 개발
    1. 금융권 신탁자산관리 업무 개발
    1. 퇴직 연금 업무 개발
    1. 트레이딩 해외 주식 채원 선물옵션 및 파생상품 거래 시스템 개발
    1. Data Modeling(데이터모델링 Erwin, 표준용어관리(메타스트림))
1. 삼성증권
  - 직무 :  
    1. IT 부문 전략 수립
    1. 시스템 개발
  ...
  - 자소서 :
    ...
    1. 존경인물(10자)
    1. 존경이유(40자)
    1. 삼성증권을 지원한 이유, 입사 후 목표(700자)
    1. 본인의 성장과정을 간략히 기술하되 현재의 자신에게 가장 큰 영향을 끼친 사건, 인물 등 포함 기술(1500)
    1. 사회 이휴 중 중요하가도 생각되는 한 가지를 선택하고 이에 관한 자신의 견해를 기술(1000)
    1. 기존의 방식에 머무르지 않고 새로운 방식으로 접근하여 성공한 경험 및 도전적인 목표를 세우고 달성을 위해 노력한 경험 중 1가지 기술(1000)
1. 교보증권
  - 직무 :
    1. IT
  - 가산 :
...
8월 말에 정처기/ADsP/SQLD 3개 시험이 모두 있으므로 7월 8월은 자격증 3개 취득 목표
...
1. 정보처리기사
  - 교재 : 시나공2020
1. ADsP(Advanced Data Analytics Semi-Professional) (한달)
  - 필기 : 데이터 이해/분석 기획/ 분석
  - 교재 : 데이터 에듀 데이터분석준전문가
1. DAsP(Data Architecture Semi-Professional) ( 2주 )
  - 필기 : 전사아키텍쳐 이해/ 데이터 요건분석 / 데이터 표준화 / 데이터 모델링
  - 교재 : [데이터아키텍처 전문가 가이드](https://book.naver.com/bookdb/book_detail.nhn?bid=6253877)
1. 정보보안기사
